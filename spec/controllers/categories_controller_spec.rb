...
RSpec.describe CategoriesController, type: :controller do
  ...
  # adjust the attributes here as well.
   let(:movies){[ 
         ...
         attributes_for(:movie, name: "la sombra del mar", year: 2000),
         attributes_for(:movie, name: "batman", year: 2019)
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
            {
                name: "nuevo terror",
                description: "terror actualizado"
            }      
       }
      ...
      it "updates the requested category" do
        ...
        category.reload
        expect(category.name).to eq "nuevo terror"   end
